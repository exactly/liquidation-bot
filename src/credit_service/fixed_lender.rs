...
pub struct FixedLender {
    ...
    penalty_rate: Option<U256>,
    adjust_factor: Option<U256>,
    decimals: Option<u8>,
...
impl FixedLender {
    ...
    pub fn set_asset_symbol(&mut self, asset_symbol: Option<String>) {
        self.asset_symbol = asset_symbol;
    }

    pub fn set_underlying_asset(&mut self, underlying_asset: Option<Address>) {
    ...
    pub fn underlying_asset(&self) -> Option<H160> {
